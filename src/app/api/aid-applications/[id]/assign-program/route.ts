...
import { assignAidProgram } from "@/lib/aid/application-service";
...
export async function POST(
  ...
  try {
    ...
    const application = await assignAidProgram({
      applicationId: id,
      payload: body,
    ...
    return toAidErrorResponse(error, "Failed to assign aid program.");
  }
}

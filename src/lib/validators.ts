...
export const identitasSchema = z.object({
  ...
  tanggal_lahir: z.date({ required_error: 'Tanggal lahir tidak boleh kosong.' }),
  jenis_kelamin: z.enum(['LAKI_LAKI', 'PEREMPUAN'], { required_error: 'Jenis kelamin tidak boleh kosong.' }),
  ...
  jumlah_anggota_keluarga: z.number().min(1, { message: 'Jumlah anggota keluarga minimal 1.' }),
});
